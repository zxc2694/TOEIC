...
BOOL voiceDlg::OnInitDialog()
{
	...
	if (m_Video == NULL)
	{
		...
		if(mDay == 2)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 02.mp3"));
		if(mDay == 3)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 03.mp3"));
		if(mDay == 4)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 04.mp3"));
		if(mDay == 5)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 05.mp3"));
		if(mDay == 6)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 06.mp3"));
		if(mDay == 7)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 07.mp3"));
		if(mDay == 8)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 08.mp3"));
		if(mDay == 9)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 09.mp3"));
		if(mDay == 10)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 10.mp3"));
		if(mDay == 11)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 11.mp3"));
		if(mDay == 12)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 12.mp3"));
		if(mDay == 13)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 13.mp3"));
		if(mDay == 14)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 14.mp3"));
		if(mDay == 15)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 15.mp3"));
		if(mDay == 16)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 16.mp3"));
		if(mDay == 17)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 17.mp3"));
		if(mDay == 18)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 18.mp3"));
		if(mDay == 19)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 19.mp3"));
		if(mDay == 20)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 20.mp3"));
		if(mDay == 21)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 21.mp3"));
		if(mDay == 22)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 22.mp3"));
		if(mDay == 23)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 23.mp3"));
		if(mDay == 24)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 24.mp3"));
		if(mDay == 25)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 25.mp3"));
		if(mDay == 26)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 26.mp3"));
		if(mDay == 27)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 27.mp3"));
		if(mDay == 28)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 28.mp3"));
		if(mDay == 29)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 29.mp3"));
		if(mDay == 30)	m_Video = MCIWndCreate(this->GetSafeHwnd(),
		   AfxGetInstanceHandle(), WS_CHILD | WS_VISIBLE, _T("TOEIC\\Day 30.mp3"));
	}
	else
	{
		MCIWndHome(m_Video);
